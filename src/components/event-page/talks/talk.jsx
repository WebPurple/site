    ...
    <TalkGrid>
        ...
        <div>
            ...
            { talk.links ? <LinksGrid>
                {
                    talk.links.video ?
                        <FileLink href={talk.links.video} target="__blank"><WatchIconStyled />Video</FileLink> :
                        null
                }
                {
                    talk.links.presentation ?
                        <FileLink href={talk.links.presentation} target="__blank"><DownloadIconStyled />Presentation</FileLink> :
                        null
                }
            </LinksGrid> : null }
        </div>
