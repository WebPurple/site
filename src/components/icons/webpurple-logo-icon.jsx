...
const WebpurpleLogoIcon = ({ isGray }) => (
    <svg
        width="35px"
        height="31px"
        viewBox="0 0 35 31"
            ...
            <g transform="translate(-612.000000, -209.000000)">
                <g transform="translate(516.000000, 169.000000)">
                    <g transform="translate(96.000000, 40.000000)">
                        <g>
                            <g transform="translate(-0.000000, 0.206061)" id="logo-icon">
                                <polygon
                                    fill={isGray ? '#b3a8c1' : 'url(#linearGradient-1)'}
                                    points="25.884174 30.7265263 25.9148433 0.0504544753 34.522761 5.15369572 34.4920916 25.6232851" />
                                <polygon
                                    fill={isGray ? '#b3a8c1' : 'url(#linearGradient-2)'}
                                ...
                                <polygon
                                    fill={isGray ? '#b3a8c1' : 'url(#linearGradient-3)'}
                                    opacity={isGray ? 1 : 0.4}
                                    style={{ mixBlendMode: isGray ? 'normal' : 'multiply' }}
                                    points="8.66226382 30.7265263 17.2762563 15.4107988 0.0543461312 25.6232851" />
                                <polygon
                                    fill={isGray ? '#b3a8c1' : 'url(#linearGradient-4)'}
...
export default WebpurpleLogoIcon;
