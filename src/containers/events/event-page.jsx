...
class EventPageContainer extends React.Component {
  static propTypes = {
    ...
    match: PropTypes.object, // react-router filling this prop
    loadEvent: PropTypes.func,
    cleanEvent: PropTypes.func,
    becomeAttendee: PropTypes.func,
    stopBeingAttendee: PropTypes.func,
  }
  ...
  becomeAttendee() {
    return this.props.becomeAttendee(
  ...
  stopBeingAttendee() {
    return this.props.stopBeingAttendee(
      this.props.match.params.eventId,
      this.props.currentUser,
    )
  }
