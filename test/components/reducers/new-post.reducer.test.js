...
var newPostReducer = require('./../../../components/reducers/new-post.reducer.ts').default;
var OPEN_DIALOG = require('./../../../components/actions/post-edit-form.actions.ts').OPEN_DIALOG;
var CLOSE_DIALOG = require('./../../../components/actions/post-edit-form.actions.ts').CLOSE_DIALOG;
